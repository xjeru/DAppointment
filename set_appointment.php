	...
	<div class="col-lg-12">
		...
		<form action="" id="manage-appointment">
			...
			<div class="form-group">
				...
				<input type="text" value="<?php echo $_GET['name'] ?>" name="name" class="form-control" required>
			</div>

			<div class="form-group">
				<label for="" class="control-label">Contact</label>
				<input type="text" value="<?php echo $_GET['contact'] ?>" name="contact" class="form-control" required>
			</div>

			<div class="form-group">
				<label for="" class="control-label">Address</label>
				<input type="text" value="<?php echo $_GET['address'] ?>" name="address" class="form-control" required>
			</div>
